...
const CRMSchema = z.object({
            ...
            crm_status : z.enum(["GOOD_LEAD_FOLLOW_UP", "DID_NOT_CONNECT", "BAD_LEAD", "SALE_DONE"]).optional().describe("Only use one of: GOOD_LEAD_FOLLOW_UP, DID_NOT_CONNECT, BAD_LEAD, SALE_DONE"),
            ...
            data_source : z.enum(["leads_on_demand", "meridian_tower", "eden_park", "varah_swamy", "sarjapur_plots"]).optional().describe("Only use one of: [ leads_on_demand, meridian_tower, eden_park, varah_swamy, sarjapur_plots ]" ,"If none match confidently, leave it blank."),
            possession_time : z.date().optional().describe("Property possession time "),
